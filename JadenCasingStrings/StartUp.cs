namespace JadenCasingStrings
{
    ...
    public static class StartUp
    {
         ...
         *he is known for almost always capitalizing every word. Your task is to convert strings to how they would be written by Jaden Smith. 
        ...
        {
            return  CultureInfo.InvariantCulture.TextInfo.ToTitleCase(phrase);
        }
    }
}
